    ...
    public function index()
    {
        ...
        if($user){
            ...
            if(($asstes + $ass) > 0){
              ...
              $notice=Db::table('mb_notice')->order('time', 'desc')->field('n_text')->select();
...
//            }
            ...
            if($user_arr){
                return jsonp(['code' => 1, 'msg' => 'succeed','data'=>$user_arr,'images'=>$data,'tan'=>$tan,'beijin'=>$beijin,'gold'=>$asstes + $ass,'notice'=>$notice]);
            }else{
