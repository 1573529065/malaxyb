<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\card.html";i:1529219038;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-cogs"></i>会员银行卡</div>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr>
                                ...
                                <th class="numeric">持卡人姓名</th>

                                <th class="numeric">银行</th>

                                <th class="numeric">银行卡号</th>

                                <th class="numeric">支行</th>
                                <th class="numeric">是否默认</th>
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="持卡人姓名" class="numeric"><?php echo $v['c_name']?></td>
                                <td data-title="银行" class="numeric"><?php echo $v['bn_name']?></td>
                                <td data-title="银行卡号" class="numeric"><?php echo $v['b_card']?></td>
                                <td data-title="支行" class="numeric"><?php if(!$v['b_branch']){ echo '无'; }else{ echo $v['b_branch'];}?></td>
                                <td data-title="是否默认" class="numeric"><?php if($v['defult'] == 1){ echo '是'; }else{ echo '否';}?></td>
