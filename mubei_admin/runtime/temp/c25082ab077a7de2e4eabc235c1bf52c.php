<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\user\add_user.html";i:1527130344;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="portlet-body form">
        ...
        <form action="#" class="form-horizontal form-bordered form-row-stripped">
          ...
          <div class="control-group">
                ...
                <label class="control-label">上级uid</label>

                <div class="controls">

                    <input type="text" id="fuid" value="" class="m-wrap span12">
