<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\config.html";i:1525949356;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
                    ...
                    <form action="#" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">单位:百分比（vip会员下级的第一代会员兑换积分加速释放比例）</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">单位:百分比（vip会员下级的第二代至第十五代兑换积分加速释放比例）</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="number" id="target<?php echo $config3['co_id']?>" onchange="check(<?php echo $config3['co_id']?>)"
                                       placeholder="medium" value="<?php echo $config3['co_config']?>" class="m-wrap medium">

                                <span class="help-inline">单位:百分比（普通会员下级的第一代会员兑换积分加速释放比例）</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">单位:百分比（普通会员下级的第二代至第十五代兑换积分加速释放比例）</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">单位:千分比（每日静态释放积分到资产比例）</span>
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label"><?php echo $config8['co_name']?></label>

                            <div class="controls">

                                <div class="input-append bootstrap-timepicker-component">

                                    <input disabled="true" id="target<?php echo $config8['co_id']?>"
                                           onchange="check(<?php echo $config8['co_id']?>)" class="m-wrap m-ctrl-small timepicker-24"
                                           placeholder="<?php echo date('H:i:s',$config8['co_config'])?>" type="text">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">单位:百分比（资产兑换积分比例 例如100资产兑换积分 得600积分）</span>
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label"><?php echo $config9['co_name']?></label>

                            <div class="controls">

                                <input type="number" id="target<?php echo $config9['co_id']?>"
                                       onchange="check(<?php echo $config9['co_id']?>)"
                                       placeholder="medium" value="<?php echo $config9['co_config']?>" class="m-wrap medium">

                                <span class="help-inline">单位:百分比（vip所属下级转账获取转账金额的8%积分奖励）</span>
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label"><?php echo $config10['co_name']?></label>

                            <div class="controls">

                                <input type="number" id="target<?php echo $config10['co_id']?>"
                                       onchange="check(<?php echo $config10['co_id']?>)" placeholder="medium"
                                       value="<?php echo $config10['co_config']?>" class="m-wrap medium">

                                <span class="help-inline">单位:百分比（vip所属下级转账 如果转账双方都是vip 则只获得2%的积分奖励）</span>
