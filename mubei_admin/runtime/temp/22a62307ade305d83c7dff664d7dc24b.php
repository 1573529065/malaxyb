<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\user\change_pass.html";i:1525949358;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box blue ">
    ...
    <div class="portlet-title">
        ...
        <div class="caption"><i class="icon-reorder"></i>修改管理员</div>
    </div>
        ...
        <form action="#" class="form-horizontal form-bordered form-row-stripped">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="uid" value="<?php echo $user ?>"  disabled="true" class="m-wrap span12">
...
//
            $.ajax({
                url: "<?php echo url('index/user/change_pass_p2'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    uid: $('#user').val(),
