<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:102:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\user\add_card_p3.html";i:1525949358;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box blue ">
    ...
    <div class="portlet-title">
        ...
        <div class="caption"><i class="icon-reorder"></i>修改银行</div>
    </div>
        ...
        <form action="#" class="form-horizontal form-bordered form-row-stripped">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="title" value="<?php echo $user['bn_name']?>"  class="m-wrap span12">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn blue" onclick="send(<?php echo $user['bn_id']?>)"><i class="icon-ok"></i> 修改</button>
...
<script>
    ...
    function send(nid){
        if(!$('#title').val()){
            ...
            $.ajax({
                url: "<?php echo url('index/menu/add_card_p4'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    title: $('#title').val(),
