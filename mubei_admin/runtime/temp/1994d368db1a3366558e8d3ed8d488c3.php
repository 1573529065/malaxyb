<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:110:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\search_asstes_order.html";i:1525949356;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <div class="text-c">
                        <form action="<?php echo url('index/menu/search_asstes_order'); ?>" method="post">
                        时间范围查询：
                        <input  type="text" onfocus="WdatePicker()" id="date_start" name="date_start" class="input-text Wdate" value="<?php echo $time1; ?>"
                               style="width:120px;margin-top: 8px;" required> -
                        <input  type="text" onfocus="WdatePicker()" id="date_end" value="<?php echo $time2; ?>"
                                                                       name="date_end" class="input-text Wdate" style="width:120px;margin-top: 8px;"
                                                                       required>
                            <input type="text" placeholder="请输入uid" value="<?php echo $uid; ?>" name="uid" style="width:120px;margin-top: 8px;"/>
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="业务类型"> <?php if($v['type'] == 1){ ?>
                                    <?php echo '签到';}else if($v['type'] == 2){ echo '加速释放';}
                    else if($v['type'] == 3){ echo '兑换积分';}else if($v['type'] == 4){ echo '转入';}
                    else if($v['type'] == 5){ echo '转出';}else if($v['type'] == 10){ echo 'VIP积分奖励';}

                     ?>
                                </td>
                                <td data-title="数额" class="numeric"><?php echo $v['ao_money']?></td>
                                <td data-title="时间" class="numeric"><?php echo date('Y-m-d H:i:s', $v['ao_time']) ?></td>
