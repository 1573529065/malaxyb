<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\reply_feedback.html";i:1528820473;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    function send(f_id){
        if(!$('#f_content').val()){
            ...
            $.ajax({
                url: "<?php echo url('index/menu/replyFeedback1'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: {
