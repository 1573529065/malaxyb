<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\user\add_admin.html";i:1525949358;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="portlet-body form">
        ...
        <form action="#" class="form-horizontal form-bordered form-row-stripped">
            ...
            <div class="control-group">
                ...
                <label class="control-label">是否具备操作权限</label>
...
<script>
    ...
    function send(){
            ...
            $.ajax({
                url: "<?php echo url('index/user/add_admin_p2'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: {
                    u_id: $('#uid').val(),
