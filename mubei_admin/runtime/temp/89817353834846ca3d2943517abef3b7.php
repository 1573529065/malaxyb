<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:103:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\user\assets_order.html";i:1525949358;}*/ ?>
<!DOCTYPE html>
        ...
        <table class="table-bordered table-striped table-condensed cf">
            ...
            <tr style="text-align: center">
                <td data-title="业务类型">
                    ...
                    else if($v['type'] == 4){ echo '转入';}
                    else if($v['type'] == 5){ echo '转出';}
