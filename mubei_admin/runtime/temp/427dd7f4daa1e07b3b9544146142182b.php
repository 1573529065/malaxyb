<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\message.html";i:1525949356;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="dashboard">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption"><i class="icon-cogs"></i>消息列表</div>
                ...
                <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                    ...
                    <table class="table-bordered table-striped table-condensed cf">
                        ...
                        <tr>
                            <th>用户uid</th>
                            <th class="numeric">消息标题</th>
                            <th class="numeric">消息内容</th>
                        ...
                        <tr style="text-align: center">
                            ...
                            <td data-title="公告内容"><?php echo $vo['m_text']?></td>
                            <td data-title="公告内容"><?php echo $vo['m_text']?></td>
                            <td data-title="时间" class="numeric"><?php echo date('Y-m-d H:i:s', $vo['m_time']) ?></td>
                            <?php if($admin['type'] != 2){ ?>
                            <td data-title="操作" class="numeric"><button type="button" class="btn red" onclick="delete_n(<?php echo $vo['m_id']?>)">删除</button>
                            <?php }?>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    ...
    function delete_n(nid){
        ...
        $('#yes').click(function(){
            $.ajax({
                type: "post",
                url: "<?php echo url('index/menu/delete_message'); ?>",
                dataType: "json",
                data: {
                    mid:nid
                },
