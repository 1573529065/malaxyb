<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\sell.html";i:1525949356;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-content">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="javascript:;">卖出挂单</a></li>
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-cogs"></i>卖出挂单</div>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr>
                                ...
                                <th>卖出用户uid</th>
                                <th class="numeric">卖出金额</th>
                                <!--<th>Company</th>-->
                                <th class="numeric">买入用户uid</th>
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="交易状态">  <?php if($vo['static'] == 1){ ?>
                                    <?php echo '挂卖中';}else if($vo['static'] == 2){ echo '等待支付';}
        ...
        <div id="myModal1" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="false" style="display: none;height: 200px;">
            ...
            <div class="modal-header">
                ...
                <button type="button" onclick="remo()" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            <div class="modal-footer">
                ...
                <button class="btn" onclick="remo()" id="nonot" data-dismiss="modal" aria-hidden="true">取消</button>
...
<script>
    ...
    function delete_order(){
        ...
        $('#yes').click(function(){
            $.ajax({
                type: "post",
                url: "<?php echo url('index/menu/delete_sell_order'); ?>",
                dataType: "json",
                data: {},
