<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\shensu.html";i:1525949356;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="javascript:;">申诉管理</a></li>
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-cogs"></i>申诉管理</div>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="申诉图片" class="numeric"><img style="width: 300px;height: 150px;"
                                                                           src="<?php echo  '/new_vpay_api/public/static/uploads/'.$v['ss_img']?>" alt=""/>
                                </td>
                                <td data-title="时间" class="numeric"><?php echo date('Y-m-d H:i:s', $v['time']) ?></td>
                                <?php if($admin['type'] != 2){ ?>
                                <td data-title="操作" class="numeric">
                                    <button type="button" class="btn red" onclick="delete_n(<?php echo $v['ss_id']?>)">驳回</button>
                                    <input type="hidden" value="<?php echo $v['ss_img']?>" id="imag"/>
                                    <button onclick="ageree(<?php echo $v['ss_id']?>)" type="button" class="btn blue">同意</button></td>
                                <?php }?>
                            </tr>
                            <?php } ?>
                        ...
                        <div id="myModal2" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="false" style="display: none;height: 200px;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn" id="nonot1" data-dismiss="modal" aria-hidden="true">取消</button>

                                <button class="btn yellow" id="yes1">确定</button>
...
<script>
    ...
    function delete_n(nid){
        ...
        $('#yes').click(function(){
            $.ajax({
                type: "post",
                url: "<?php echo url('index/menu/delete_shensu'); ?>",
                dataType: "json",
                data: {
                    nid:nid,
                    image:img
    ...
    function ageree(nid){
        ...
        $('#yes1').click(function(){
            $.ajax({
                type: "post",
                url: "<?php echo url('index/menu/ageree'); ?>",
                dataType: "json",
                data: {
                    nid:nid,
                    image:img
