<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"/www/wwwroot/www.malaxyb.com/mubei_admin/public/../application/index/view/index/select_user.html";i:1525949356;s:92:"/www/wwwroot/www.malaxyb.com/mubei_admin/public/../application/index/view/common/common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="form-search"  style="float: left;width: 80%;margin-bottom: 1%;" >
                        ...
                        <div class="chat-form" style="margin: 0 0 0 1%;padding: 0; width: 100%">
                            ...
                            <div class="input-cont" style="width: 82%;float: left">
                                ...
                                <input type="text" style="width: 100%;" value="" name="u_id"  placeholder="用户id或手机号" class="m-wrap">
                                ...
                                <td data-title="操作" class="numeric">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="javascript:;" onclick="admin_add('发送资产','<?php echo url('index/user/send_money?account='.$v['u_id']); ?>','400','400')"><i class="icon-pencil"></i>发送资产</a></li>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="javascript:;" onclick="admin_add('资产记录','<?php echo url('index/user/money_order?account='.$v['u_id']); ?>','400','400')"><i class="icon-trash"></i>查看资产记录</a></li>
...
<script>
    ...
    function select_user_all(){
        setTimeout(function(){window.location.href="<?php echo url('index/index/index'); ?>" },200);
    }
