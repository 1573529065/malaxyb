<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\menu\feedback.html";i:1528820775;s:99:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mubei_admin\public/../application/index\view\common\common.html";i:1525949356;}*/ ?>
<!DOCTYPE html>
                            ...
                            <td data-title="操作" class="numeric">
                                <div class="btn-group">
                                    <a class="btn green" href="#" data-toggle="dropdown">
                                        <i class="icon-user"></i> 建议管理
                                        <i class="icon-angle-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="javascript:;"
                                               onclick="admin_add('编辑用户','<?php echo url('index/menu/reply_feedback?f_id='.$vo['f_id']); ?>','400','400')">
                                            <i class="icon-pencil"></i>回复建议</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
