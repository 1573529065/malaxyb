<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\phpStudy\PHPTutorial\WWW\mall\public/../application/index\view\address\search.html";i:1527577998;s:84:"E:\phpStudy\PHPTutorial\WWW\mall\public/../application/index\view\common\common.html";i:1527572840;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <input type="text" placeholder="请输入用户id/用户昵称/用户真实姓名"name='search' value='<?php echo $search; ?>'>
                <span>状态:</span>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr style="text-align: center">
                                ...
                                <td class="numeric"> <button class="<?php if($data['status'] == 1): ?>layui-btn<?php else: ?>layui-btn layui-btn-danger<?php endif; ?>" id = 'btn<?php echo $key; ?>' onclick = 'changestatus(<?php echo $key; ?>)'><?php if($data['status'] == 1): ?>已启用<?php else: ?>已禁用<?php endif; ?></button></td>                                                                                
