<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\menu\user_money_order.html";i:1523932324;s:82:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\common\common.html";i:1523932677;}*/ ?>
<!DOCTYPE html>
...
<div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <!--</li>-->
            <li class="start <?php if($fun == 'user_money_order'){echo 'active';}else if($fun == 'user_money_order'){echo 'active';}?>" >
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="javascript:;">用户余额记录</a></li>
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-cogs"></i>用户余额记录</div>
