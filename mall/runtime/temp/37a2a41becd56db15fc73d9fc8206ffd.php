<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mall\public/../application/index\view\order\index.html";i:1527685578;s:92:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mall\public/../application/index\view\common\common.html";i:1528738885;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <form action="<?php echo url('index/Order/search'); ?>" method='post' style="float:left">
                    ...
                    <?php if($admin['type'] == 1): ?>
                     <input type="text" placeholder="输入用户id/商品名/分类名/店铺名"name='search' value=''>
                    <?php else: ?>
                     <input type="text" placeholder="请输入用户id或者商品名"name='search' value=''>
                    <?php endif; ?>
