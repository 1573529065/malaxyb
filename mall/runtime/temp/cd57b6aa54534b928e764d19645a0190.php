<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"E:\phpStudy\PHPTutorial\WWW\hpay_admin\public/../application/index\view\user\change_beijin.html";i:1525511181;}*/ ?>
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="#" class="form-horizontal">
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div class="fileupload-new thumbnail" style="width: 300px; height: 150px;">
                                            ...
                                            <img style="width: 100%;height: 100%;"
                                                    src="<?php echo  '/new_vpay_api/public/static/uploads/'.$shop['bj_img']?>" alt="">
                            ...
                            <input type="hidden" value="<?php echo $shop['bj_img']?>" id="img"/>
                            <input type="hidden" value="<?php echo $shop['bj_id']?>" id="lbid"/>
...
<script>
    ...
    function send(){
        ...
        if(!formData){
            ...
            $.ajax({
                url: "<?php echo url('index/menu/change_beijin'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: formData,
