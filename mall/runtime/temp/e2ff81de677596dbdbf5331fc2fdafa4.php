<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\menu\add_card.html";i:1523630149;s:82:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\common\common.html";i:1523932712;}*/ ?>
<!DOCTYPE html>
...
<div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <!--</li>-->
            <li class="start <?php if($fun == 'user_money_order'){echo 'active';}else if($fun == 'search_money_order'){echo 'active';}?>" >
            ...
            <!--</li>-->
            <li class="start <?php if($fun == 'user_assets_order'){echo 'active';}else if($fun == 'search_asstes_order'){echo 'active';}?>" >
...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div id="dashboard">
            ...
            <a href="javascript:;" onclick="notice_add()" class="btn blue"><i class="icon-plus"></i>添加银行</a>

            <form class="form form-horizontal" id="form-admin-add" style="display:none">
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">银行名：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="" id="title" name="title" style="width: 50%;">
                    </div>
                </div>
                <div class="row cl">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption"><i class="icon-cogs"></i>银行管理</div>
                ...
                <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                    ...
                    <table class="table-bordered table-striped table-condensed cf">
                        ...
                        <tr  style="text-align: center">
                            ...
                            <th  style="text-align: center" class="numeric">操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach($order as $vo ){ ?>
                        <tr style="text-align: center">
                            <td data-title="银行名"><?php echo $vo['bn_name']?></td>
                            <td data-title="操作" class="numeric"><button type="button" class="btn red" onclick="delete_n(<?php echo $vo['bn_id']?>)">删除</button>
                                <button onclick="admin_add('修改银行','<?php echo url('index/user/add_card_p3?nid='.$vo['bn_id']); ?>','400','400')" type="button" class="btn blue">修改</button></td>
                        </tr>
                        <?php } ?>
                        </tbody>
...
<script>
    ...
    function delete_n(nid){
        ...
        $('#yes').click(function(){
            $.ajax({
                type: "post",
                url: "<?php echo url('index/menu/add_card_p2'); ?>",
                dataType: "json",
                data: {
                    nid:nid
                },
    ...
    function send() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('index/menu/add_card_p1'); ?>",
            dataType: "json",
            data: {
                title:title
            },
