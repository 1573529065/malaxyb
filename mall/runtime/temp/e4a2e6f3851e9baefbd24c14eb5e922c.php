                                ...
                                <td data-title="操作" class="numeric">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="javascript:;" onclick="admin_add('资产记录','<?php echo url('index/user/assets_order?account='.$v['u_id']); ?>','400','400')"><i class="icon-remove"></i>查看积分记录</a></li>
                                        </ul>
                                    </div>
                                    <?php if($v['status'] == 1){ ?>
                                    <div class="btn-group">
