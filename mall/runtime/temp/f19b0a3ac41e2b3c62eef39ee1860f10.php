<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\menu\noticemanage.html";i:1523631170;s:82:"D:\phpStudy\WWW\new_vpay_admin\public/../application/index\view\common\common.html";i:1523932712;}*/ ?>
<!DOCTYPE html>
...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div id="dashboard">
            ...
            <a href="javascript:;" onclick="notice_add()" class="btn blue"><i class="icon-plus"></i>添加公告</a>
            ...
            <form class="form form-horizontal" id="form-admin-add" style="display:none">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <textarea id="editor" placeholder="" autofocus  class="textarea" ></textarea>
                ...
                <div class="row cl">
                    <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                        <span class="btn btn-primary radius" onclick="send()">发布</span>
                    </div>
                </div>
                <br>
            </form>
                ...
                <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                    ...
                    <table class="table-bordered table-striped table-condensed cf">
                        ...
                        <tr style="text-align: center">
                            <td data-title="公告标题"><?php echo $vo['n_title']?></td>
                            <td data-title="公告内容"><?php echo $vo['n_text']?></td>
                            <td data-title="时间" class="numeric"><?php echo date('Y-m-d H:i:s', $vo['time']) ?></td>
                            <td data-title="操作" class="numeric"><button type="button" class="btn red" onclick="delete_n(<?php echo $vo['n_id']?>)">删除</button>
                                <button onclick="admin_add('修改公告','<?php echo url('index/user/noticemanage_t?nid='.$vo['n_id']); ?>','400','400')" type="button" class="btn blue">修改</button></td>
                        </tr>
                        <?php } ?>
                        </tbody>
