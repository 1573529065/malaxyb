<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\index\index.html";i:1523767485;s:80:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\common\common.html";i:1523673348;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="form-search"  style="float: left;width: 80%;margin-bottom: 1%;" >
                    ...
                    <div class="chat-form" style="margin: 0 0 0 1%;padding: 0; width: 100%">
                        ...
                        <div class="input-cont" style="width: 82%;float: left">
                            ...
                            <input type="text" style="width: 100%;" id="uid" placeholder="用户id或手机号" class="m-wrap">

                        </div>

                        <div style="float: right;width: 11%;">
                            <button onclick="select_user()" style="width: 100%;" type="button" class="btn green">搜索 &nbsp; <i class="m-icon-swapright m-icon-white"></i></button>
                        </div>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="流通资产" class="numeric"><?php echo $v['current']?></td>
                                <td data-title="固定资产" class="numeric"><?php echo $v['assets']?></td>
                                ...
                                <td data-title="操作" class="numeric">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="javascript:;" onclick="admin_add('流通记录','<?php echo url('index/user/score_order?account='.$v['u_id']); ?>','400','400')"><i class="icon-remove"></i>查看流通记录</a></li>
                                            <li><a href="javascript:;" onclick="admin_add('资产记录','<?php echo url('index/user/assets_order?account='.$v['u_id']); ?>','400','400')"><i class="icon-remove"></i>查看资产记录</a></li>
                                        </ul>
                                    </div>
                                    <?php if($v['status'] == 1){ ?>
                                    <div class="btn-group">
