<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/mubei8.com/mall/public/../application/index/view/order/search.html";i:1527685598;s:80:"/www/wwwroot/mubei8.com/mall/public/../application/index/view/common/common.html";i:1527652641;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <form action="<?php echo url('index/Order/search'); ?>" method='post' style="float:left">

                   
                    <?php if($admin['type'] == 1): ?>
                     <input type="text" placeholder="输入用户id/商品名/分类名/店铺名"name='search' value='<?php echo $search; ?>'>
                    <?php else: ?>
                     <input type="text" placeholder="请输入用户id或者商品名"name='search' value='<?php echo $search; ?>'>
                    <?php endif; ?>

                <select name="status" id="status" >
                    <option value="-1" <?php if($status == -1): ?>selected<?php endif; ?> >所有订单状态</option>
                    <option value="0" <?php if($status == 0): ?>selected<?php endif; ?>>未付款</option>
                    <option value="1" <?php if($status == 1): ?>selected<?php endif; ?>>已付款</option>
                ...
                <a href="javascript:exportExcel()" class="btn blue" style="margin:0 10px;float:left">导出excel表</a>
     ...
     function exportExcel(){
        ...
        if($('#order').children().length <= 0){
            ...
            if($('input[name="search"]').val() == ''){
                window.location.href = '/mall/public/index/Order/orderExport/status/'+$('select[name="status"]').val()+'/time1/'+$('#test1').val()+'/time2/'+$('#test2').val();
            
            }else{
                 window.location.href = '/mall/public/index/Order/orderExport/search/'+$('input[name="search"]').val()+'/status/'+$('select[name="status"]').val()+'/time1/'+$('#test1').val()+'/time2/'+$('#test2').val();
            }
        }
