<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/default/hpay_admin/public/../application/index/view/menu/share.html";i:1525486480;s:84:"/home/wwwroot/default/hpay_admin/public/../application/index/view/common/common.html";i:1525486479;}*/ ?>
<!DOCTYPE html>
...
<div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="start <?php if($fun == 'lunbo'){echo 'active';}?>" >

                <a href="<?php echo url('index/menu/lunbo'); ?>">

                    <i class="icon-sitemap"></i>

                    <span class="title">配置app轮播图</span>
            ...
            <li class="start <?php if($fun == 'beijin'){echo 'active';}?>" >

                <a href="<?php echo url('index/menu/beijin'); ?>">

                    <i class="icon-sitemap"></i>

                    <span class="title">配置app背景图</span>
            ...
            <li class="start <?php if($fun == 'shensu'){echo 'active';}?>" >

                <a href="<?php echo url('index/menu/shensu'); ?>">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="javascript:;">分享记录</a></li>
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-cogs"></i>分享记录</div>
                    ...
                    <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                        ...
                        <table class="table-bordered table-striped table-condensed cf">
                            ...
                            <tr style="text-align: center">
                                ...
                                <td data-title="分享用户"><?php echo $vo['user']?></td>
