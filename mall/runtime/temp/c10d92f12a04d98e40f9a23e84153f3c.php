<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\phpStudy\PHPTutorial\WWW\mall\public/../application/index\view\order\search.html";i:1527564743;s:84:"E:\phpStudy\PHPTutorial\WWW\mall\public/../application/index\view\common\common.html";i:1527572840;}*/ ?>
<!DOCTYPE html>
     ...
     function exportExcel(){
        ...
        if($('#order').children().length <= 0){
            ...
            if($('input[name="search"]').val() == ''){
                window.location.href = '/public/index/Order/orderExport/status/'+$('select[name="status"]').val()+'/time1/'+$('#test1').val()+'/time2/'+$('#test2').val();
            
            }else{
                 window.location.href = '/public/index/Order/orderExport/search/'+$('input[name="search"]').val()+'/status/'+$('select[name="status"]').val()+'/time1/'+$('#test1').val()+'/time2/'+$('#test2').val();
            }
        }
