<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"E:\phpStudy\PHPTutorial\WWW\hpay_admin\public/../application/index\view\menu\search_money_order.html";i:1525949321;s:90:"E:\phpStudy\PHPTutorial\WWW\hpay_admin\public/../application/index\view\common\common.html";i:1525511179;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container-fluid">
            ...
            <div id="dashboard">
                ...
                <div class="portlet box blue">
                    ...
                    else if($v['type'] == 6){ echo '转出';}else if($v['type'] == 7){ echo '转入';}else if($v['type'] == 8){ echo '兑换固定资产';}
                     if($v['target_uid'] != 0) { ?>
