<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\user\add_shop.html";i:1523697826;}*/ ?>
...
<div class="page-container row-fluid">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-reorder"></i>发布商品</div>
                    </div>
...
<script>
    ...
    function send(){
        ...
        if(!$('#title').val()){
            ...
            $.ajax({
                url: "<?php echo url('index/user/add_shop_p2'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: formData,
