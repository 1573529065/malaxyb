<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"E:\phpStudy\PHPTutorial\WWW\hpay_admin\public/../application/index\view\menu\beijin.html";i:1525511180;s:90:"E:\phpStudy\PHPTutorial\WWW\hpay_admin\public/../application/index\view\common\common.html";i:1525511179;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="javascript:;">背景图管理</a></li>
        ...
        <div id="dashboard">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption"><i class="icon-cogs"></i>背景图管理</div>
                ...
                <div class="portlet-body no-more-tables" style="padding-bottom: 5%;">
                    ...
                    <table class="table-bordered table-striped table-condensed cf">
                        ...
                        <tr style="text-align: center">
                            <td data-title="图片"><img style="width: 300px;height: 300px;"
                                    src="<?php echo  '/new_vpay_api/public/static/uploads/'.$vo['bj_img']?>" alt=""/></td>
                            <td data-title="时间" class="numeric"><?php echo date('Y-m-d H:i:s', $vo['time']) ?></td>
                            <?php if($admin['type'] != 2){ ?>
                            <td data-title="操作" class="numeric">
                                <input type="hidden" value="<?php echo $vo['bj_img']?>" id="imag"/>
                                <button onclick="admin_add('修改公告','<?php echo url('index/user/change_beijin?nid='.$vo['bj_id']); ?>','400','400')"
