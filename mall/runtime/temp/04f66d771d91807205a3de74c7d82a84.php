<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\user\change_shop.html";i:1523698692;}*/ ?>
...
<div class="page-container row-fluid">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-reorder"></i>修改资讯</div>
                    </div>
                        ...
                        <form action="#" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" id="title" value="<?php echo $shop['sh_title']?>"  class="m-wrap span12">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                            ...
                                            <img src="<?php echo  '/maibao/public/static/uploads/'.$shop['sh_img']?>" alt="">
                            ...
                            <div class="control-group">
                                ...
                                <div class="row cl" style="width: 80%;margin: 0 auto;">
                                    ...
                                    <div class="formControls col-xs-8 col-sm-9">
                                        <textarea id="editor" placeholder="" autofocus  class="textarea" >
                                            <?php echo $shop['sh_text']?>
                                        </textarea>
                            ...
                            <input type="hidden" value="<?php echo $shop['sh_img']?>" id="img"/>
                            <input type="hidden" value="<?php echo $shop['sh_id']?>" id="sh_id"/>
...
<script>
    ...
    function send(){
        ...
        formData.append("shid",$('#sh_id').val());
        ...
        if(!$('#title').val()){
            ...
            $.ajax({
                url: "<?php echo url('index/user/change_shop_p2'); ?>",
                type: 'POST',
                dataType: 'JSON',
                data: formData,
