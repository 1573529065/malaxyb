<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mall\public/../application/index\view\goodsclassify\index.html";i:1529241826;s:92:"D:\phpStudy\PHPTutorial\WWW\malaxyb\mall\public/../application/index\view\common\common.html";i:1528738885;}*/ ?>
<!DOCTYPE html>
...
<script>
    ...
    //删除商品分类
  	function del_crowd(cf_id){
		  ...
		  ,yes: function(index, layero){
		    $.ajax({
                type: "post",
                url: "<?php echo url('goodsclassify/delGoodsClassify'); ?>",
                dataType: "json",
                data: {
                    cf_id:cf_id,
                },
     ...
     layer.open({
      ...
      layui.use('form',function(){
      	...
      	form.on('submit',function(){
      		 $.ajax({
                    type: "post",
                    url: "<?php echo url('goodsclassify/updateGoodsClassify'); ?>",
                    dataType: "json",
                    data: {
                        cf_id:cf_id,
                        name:$('#title').val()
    ...
    function changestatus(classify_id,key){
     $.ajax({
                    type: "post",
                    url: "<?php echo url('goodsclassify/updateClassifyStatus'); ?>",
                    dataType: "json",
                    data: {
