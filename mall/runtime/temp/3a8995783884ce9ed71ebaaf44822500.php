<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\phpStudy\PHPTutorial\WWW\mall1\public/../application/index\view\address\index.html";i:1527245932;s:85:"E:\phpStudy\PHPTutorial\WWW\mall1\public/../application/index\view\common\common.html";i:1527133126;}*/ ?>
<!DOCTYPE html>
       			...
       			success:function(res){
		            ...
		            if(res.code == 1){
		               ...
		               a =  '<tr id="tr'+res.data[i].address_id+'">'+
		                 ...
		                 ?'<th><button class="layui-btn" value = 1 id = "default'+res.data[i].address_id+'"onclick="changeStatus('+res.data[i].address_id+','+res.data[i].u_id+')">默认</th>'
		                 :'<th><button value = 0 id = "default'+res.data[i].address_id+'" class="layui-btn layui-btn-normal" onclick="changeStatus('+res.data[i].address_id+','+res.data[i].u_id+')">非默认</th>';
