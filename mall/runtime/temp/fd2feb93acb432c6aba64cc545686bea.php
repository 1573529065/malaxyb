<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\user\send_money.html";i:1523626986;}*/ ?>
<!DOCTYPE html>
...
<div class="portlet box blue ">
    ...
    <div class="portlet-title">
        ...
        <div class="caption"><i class="icon-reorder"></i>发送余额</div>
    </div>
    ...
    <div class="portlet-body form">
        ...
        <form action="#" class="form-horizontal form-bordered form-row-stripped">
            ...
            <div class="control-group">
                ...
                <label class="control-label">发送余额</label>

                <div class="controls">

                    <input type="number" placeholder="请输入余额" class="m-wrap span12" id="money">
