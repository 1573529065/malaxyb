<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\menu\config.html";i:1523631915;s:80:"D:\phpStudy\WWW\maibao_admin\public/../application/index\view\common\common.html";i:1523630824;}*/ ?>
                    ...
                    <form action="#" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="number" id="target<?php echo $config8['co_id']?>" onchange="check(<?php echo $config8['co_id']?>)" placeholder="medium" value="<?php echo $config8['co_config']?>" class="m-wrap medium">
