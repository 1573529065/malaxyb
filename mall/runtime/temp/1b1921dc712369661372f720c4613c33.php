<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/home/wwwroot/default/hpay_admin/public/../application/index/view/login/update_pass.html";i:1525511180;}*/ ?>
<!DOCTYPE html>
...
<body class="login">
		...
		<form class="form-vertical login-form" action="#">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" id="user" placeholder="请输入原密码" name="username"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" id="pass" placeholder="请输入新密码" name="password"/>
			...
			<div class="form-actions">
                ...
                <button type="button" onclick="back()" class="btn">返回</button>
	...
	<!-- END CORE__static__/ PLUGINS -->

	<!-- BEGIN PA__static__/GE LEVEL PLUGINS -->
	...
	<!--<script src="__static__/media/js/login-soft.js" type="text/javascript"></script>-->
	...
	<script>
        ...
        function login(){
            if(!$('#user').val() || !$('#pass').val()){
                ...
                $.ajax({
                    url: "<?php echo url('index/login/update_pass_p'); ?>",
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        pass: $('#user').val(),
                    ...
                    success: function (res) {
                        if(res.code == 2) {
                            ...
                            setTimeout(function(){window.location.href = "<?php echo url('index/index/index'); ?>";},500);
                        }
                    }, fail: function (res) {
